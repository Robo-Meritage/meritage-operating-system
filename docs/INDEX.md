...
> |---|---|
> | README.md | Repository overview, structure map, naming conventions, getting started |
> | CLAUDE.md | Short-form AI context for Claude sessions |
> | AGENTS.md | Agent roster, authorized actions, and constraints |
> | CONTRIBUTING.md | Document standards, naming conventions, commit format, archiving rules |
> | CHANGELOG.md | Version history for MOS |
>
> ---
>
> ## Domain Model
...
> | Document | Description |
> |---|---|
> | [company/company-overview.md](company/company-overview.md) | Firm overview: services, market, fee philosophy, differentiators |
> | [company/what-we-believe.md](company/what-we-believe.md) | The beliefs that shape how Meritage thinks, advises, and operates |
>
> ---
>
> ## Executive
...
> | Document | Description |
> |---|---|
> | [executive/executive-manual.md](executive/executive-manual.md) | Weekly cadence, decision-making, meetings, KPIs, hiring, delegation |
>
> ---
>
> ## Operations
...
> | Document | Description |
> |---|---|
> | [operations/operating-principles.md](operations/operating-principles.md) | Ten core principles governing how Meritage runs |
>
> ---
>
> ## Marketing
...
> | Document | Description |
> |---|---|
> | [marketing/brand-voice.md](marketing/brand-voice.md) | Voice attributes, tone by channel, writing guidelines, editing checklist |
>
> ---
>
> ## HR
...
> | Document | Description |
> |---|---|
> | [ai/claude-context.md](ai/claude-context.md) | Full AI session context: writing style, decision framework, terminology, workflows |
>
> ---
>
> ## Decisions
...
> | Document | Description |
> |---|---|
> | [decisions/adr-001-markdown-as-source-of-truth.md](decisions/adr-001-markdown-as-source-of-truth.md) | Why all MOS documents are authored in Markdown |
>
> ---
>
> ## Assets
...
> | assets/diagrams/ | Visual diagrams referenced by documents |
> | assets/presentations/ | Final external deliverables (PDF, PPTX) |
>
> ---
>
> ## Archive
...
>
> When adding a new document: create the file per [CONTRIBUTING.md](../CONTRIBUTING.md), add a row here, update [CHANGELOG.md](../CHANGELOG.md).
>
> ---
>
